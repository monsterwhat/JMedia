  ...
  return (
    <header className="nano-header">
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        {shiopaConfig.features.enableLocalLibrary && typeof window !== "undefined" && window.location.pathname !== "/admin" && window.location.pathname !== "/admin/" && (
          <button 
        ...
        {shiopaConfig.features.header?.showThemeToggle !== false && (
          <div
            className="nano-theme-toggle-pill"
            onClick={() => {
              const next = themeMode === "dark" ? "light" : "dark"
              document.documentElement.setAttribute("data-theme", next)
              localStorage.setItem("shiopa-theme", next)
              setThemeMode(next)
            }}
          >
        ...
        {shiopaConfig.features.header?.showColorPicker !== false && (
                ...
                <div className="nano-theme-header">
                  ...
                  <div className="nano-theme-controls">
                    <button
                      ...
                      onClick={() => setThemeHue(shiopaConfig.theme.defaultHue)}
                    >
                      <FaUndo />
                    </button>
        ...
        {shiopaConfig.features.header?.showLangSelector !== false && (
