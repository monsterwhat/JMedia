# fix-video-player-bugs - Work Plan
...
- Evidence: .omo/evidence/task-<N>-fix-video-player-bugs.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-fix-video-player-bugs.<ext>
