...
public class InstallationApi {
    ...
    public Response installParakeet(@PathParam("profileId") Long profileId) {
        try {
            installationController.installParakeet(profileId);
    ...
    public Response installTesseract(@PathParam("profileId") Long profileId) {
        try {
            installationController.installTesseract(profileId);
    ...
    public Response uninstallParakeet(@PathParam("profileId") Long profileId) {
        try {
            installationController.uninstallParakeet(profileId);
    ...
    public Response uninstallTesseract(@PathParam("profileId") Long profileId) {
        try {
            installationController.uninstallTesseract(profileId);
