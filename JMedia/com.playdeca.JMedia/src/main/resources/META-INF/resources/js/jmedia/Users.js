(function(window) {
    ...
    JMedia.Users = {
        ...
        openEditUserModal: function(id, username, groupName) {
        ...
        saveUser: async function() {
            ...
            try {
                ...
                JMedia.Users.closeUserModal();
                JMedia.Users.loadUsers();
    ...
    window.loadUsers = JMedia.Users.loadUsers;
    window.openCreateUserModal = JMedia.Users.openCreateUserModal;
    window.openEditUserModal = JMedia.Users.openEditUserModal;
    window.closeUserModal = JMedia.Users.closeUserModal;
    window.saveUser = JMedia.Users.saveUser;
    window.deleteUser = JMedia.Users.deleteUser;
