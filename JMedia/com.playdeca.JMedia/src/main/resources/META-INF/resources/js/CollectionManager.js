(function(window) {
    ...
    window.CollectionManager = class {
        constructor(videoSPA) {
            ...
            window.buildEntryHtml = (videoId, entryId, orderIndex, card) => this.buildEntryHtml(videoId, entryId, orderIndex, card);
            window.addEntryToCollectionList = (videoId, entryId) => this.addEntryToCollectionList(videoId, entryId);
            ...
            window.toggleCollectionEntry = (videoId, entryId, inCollection) => this.toggleCollectionEntry(videoId, entryId, inCollection);
        ...
        buildEntryHtml(videoId, entryId, orderIndex, card) {
            let title = '';
            let metaHtml = '';
        ...
        addEntryToCollectionList(videoId, entryId) {
            ...
            const html = this.buildEntryHtml(videoId, entryId, nextOrder, card);
        ...
        async addEntry(videoId) {
            ...
            try {
                ...
                if (json.success) {
                    ...
                    this.addEntryToCollectionList(videoId, entryId);
        ...
        async playCollection(collectionId, startIndex) {
            ...
            try {
                ...
                if (json.success && json.data && json.data.videoId) {
                    this.videoSPA.playVideo(json.data.videoId);
                } else {
        ...
        toggleCollectionEntry(videoId, entryId, inCollection) {
            ...
            for (const card of cards) {
                ...
                try {
                    ...
                    if (json.success && json.data?.id) {
                        ...
                        this.addEntryToCollectionList(videoId, json.data.id);
                        added++;
                    }
                } catch (e) {}
            }
