(function(window) {
    ...
    console.log('[Import] ImportApi.js loaded');
    ...
    function updateSecondarySourceOptions() {
    ...
    JMedia.ImportApi = {
        ...
        getWebSocket: function() { return importWebSocket; },
        getImportSettings: function() { return importSettings; },
        getAdvancedConfig: function() { return advancedConfig; },

        startImportFromSearch: async (searchQuery) => {
        ...
        initImportLogic: () => {
            ...
            JMedia.ImportApi.loadAdvancedConfiguration();
            JMedia.ImportApi.setupUpdateButton();
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (apiResponse.data) {
                        ...
                        JMedia.ImportApi.loadYtDlpVersion();
                    }
                }
            } catch (error) {
        ...
        setupUpdateButton: () => {
            ...
            if (updateBtn) {
                updateBtn.onclick = JMedia.ImportApi.updateYtDlp;
            }
            const primarySourceSelect = document.getElementById('primarySource');
    ...
    window.startImportFromSearch = JMedia.ImportApi.startImportFromSearch;
    window.initImportLogic = JMedia.ImportApi.initImportLogic;
    window.updateYtDlp = JMedia.ImportApi.updateYtDlp;
    window.saveAdvancedConfiguration = JMedia.ImportApi.saveAdvancedConfiguration;
    window.importWebSocket = importWebSocket;
