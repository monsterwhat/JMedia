(function(window) {
    ...
    console.log('[Import] ImportUI.js loaded');

    JMedia.ImportUI = {
        updateHmxUrls: function() {
        ...
        uploadCookiesFile: function(file) {
            if (!file) {
        ...
        initImportView: function() {
            ...
            if (uploadBtn) {
                uploadBtn.onclick = JMedia.ImportUI.uploadCookies;
            }
            if (deleteBtn) {
                deleteBtn.onclick = JMedia.ImportUI.deleteCookies;
            }
            if (cookieFileInput) {
                cookieFileInput.onchange = function(e) {
                    ...
                    if (file) {
                        ...
                        JMedia.ImportUI.uploadCookiesFile(file);
                    }
                };
            }

            JMedia.ImportUI.updateHmxUrls();
    ...
    window.updateHmxUrls = JMedia.ImportUI.updateHmxUrls;
    window.uploadCookies = JMedia.ImportUI.uploadCookies;
    window.deleteCookies = JMedia.ImportUI.deleteCookies;
    window.uploadCookiesFile = JMedia.ImportUI.uploadCookiesFile;
    window.initImportView = JMedia.ImportUI.initImportView;
